...
async def graph_round_detail(
    ...
    comparison = await asyncio.to_thread(client.round_comparison, source_id, team) if detail and team else None
    return {"available": client.available(), "detail": detail, "comparison": comparison}
